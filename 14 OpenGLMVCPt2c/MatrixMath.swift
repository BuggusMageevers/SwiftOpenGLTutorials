...
struct FloatMatrix2: Hashable, Equatable {
    ...
    public func transpose() -> FloatMatrix2 {
...
struct FloatMatrix3: Hashable, Equatable {
    ...
    public func transpose() -> FloatMatrix3 {
    ...
    static func *(lhs: FloatMatrix3, rhs: FloatMatrix3) -> FloatMatrix3 {
        ...
        return FloatMatrix3(vector1: Float3(x: lhs.vector1.dotProduct(transpose.vector1), y: lhs.vector1.dotProduct(transpose.vector2), z: lhs.vector1.dotProduct(transpose.vector3)),
                            vector2: Float3(x: lhs.vector2.dotProduct(transpose.vector1), y: lhs.vector2.dotProduct(transpose.vector2), z: lhs.vector3.dotProduct(transpose.vector3)),
...
struct FloatMatrix4: Hashable, Equatable {
    ...
    public func transpose() -> FloatMatrix4 {
    ...
    static func *(lhs: FloatMatrix4, rhs: FloatMatrix4) -> FloatMatrix4 {
        ...
        return FloatMatrix4(vector1: Float4(x: lhs.vector1.dotProduct(transpose.vector1), y: lhs.vector1.dotProduct(transpose.vector2), z: lhs.vector1.dotProduct(transpose.vector3), w: lhs.vector1.dotProduct(transpose.vector4)),
                            vector2: Float4(x: lhs.vector2.dotProduct(transpose.vector1), y: lhs.vector2.dotProduct(transpose.vector2), z: lhs.vector3.dotProduct(transpose.vector3), w: lhs.vector2.dotProduct(transpose.vector4)),
                            vector3: Float4(x: lhs.vector3.dotProduct(transpose.vector1), y: lhs.vector3.dotProduct(transpose.vector3), z: lhs.vector3.dotProduct(transpose.vector3), w: lhs.vector3.dotProduct(transpose.vector4)),
    ...
    func rowMajorArray() -> [Float] {
        return [vector1.x, vector1.y, vector1.z, vector1.w, vector2.x, vector2.y, vector2.z, vector2.w, vector3.x, vector3.y, vector3.z, vector3.w, vector4.x, vector4.y, vector4.z, vector4.w]
    }
    func columnMajorArray() -> [Float] {
        return [vector1.x, vector2.x, vector3.x, vector4.x, vector1.y, vector2.y, vector3.y, vector4.y, vector1.z, vector2.z, vector3.z, vector4.z, vector1.w, vector2.w, vector3.w, vector4.w]
    }
    
    static func projection(fieldOfView fov: Float, aspect: Float, nearZ: Float, farZ: Float) -> FloatMatrix4 {
        return FloatMatrix4(vector1: Float4(x: (1 / tanf(fov * (Float.pi / 180.0) * 0.5)) / aspect, y: 0.0, z: 0.0, w: 0.0),
                            vector2: Float4(x: 0.0, y: 1 / tanf(fov * (Float.pi / 180.0) * 0.5), z: 0.0, w: 0.0),
    ...
    func rotateYAxis(_ radians: Float) -> FloatMatrix4 {
        ...
        return self * FloatMatrix4(vector1: Float4(x: cos(radians), y: 0.0, z: -sin(radians), w: 0.0),
                                   vector2: Float4(x: 0.0, y: 1.0, z: 0.0, w: 0.0),
                                   vector3: Float4(x: sin(radians), y: 0.0, z: cos(radians), w: 1.0),
                                   vector4: Float4(x: 0.0, y: 0.0, z: 0.0, w: 1.0))
    }
    func rotate(radians angle: Float, alongAxis axis: Float3) -> FloatMatrix4 {
